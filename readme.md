...
├── notebooks/ # Data cleaning \& preprocessing (Python)

├── sql/ # SQL queries, views, KPIs
...
\- Customer purchasing patterns indicate increasing order value over time  
...
2\. Data transformation and aggregation using SQL  

3\. KPI and analytical view creation  
...
2\. Open SQL files to recreate views  

3\. Use processed CSV files or connect to SQL Server  
